<template>
    <div>
        <div v-if="focus" @click="focus=false"
             class="absolute bg-black opacity-0 right-0 left-0 top-0 bottom-0 z-10"></div>
        <div class="relative z-10">
            ...
            <input type="text"
                   class="w-64 mr-6 bg-gray-200 border border-gray-400 pl-8 pr-3 py-1 rounded-full text-sm focus:outline-none focus:border-blue-500 focus:bg-gray-100"
                    ...
                    <router-link :to="result.links.self" class="block py-2">
                        <div class="flex items-center">
                            ...
                            <div class="pl-3">
                                ...
                                <p class="text-sm">{{ result.data.company }}</p>
                            </div>
                        </div>
                    </router-link>
                </div>
