        ...
        <div class="flex">
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <p class="pt-12 uppercase font-bold text-gray-500 text-xs">Create</p>
                    <router-link to="/contacts/create" class="flex item-center py-2 hover:text-blue-600 text-sm">
                    ...
                    <router-link to="/contacts" class="flex item-center py-2 hover:text-blue-600 text-sm">
                        ...
                        <p class="tracking-wide pl-3">Contacts</p>
                    </router-link>
                    <router-link to="/birthdays" class="flex item-center py-2 hover:text-blue-600 text-sm">
                        <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
                        ...
                        <p class="tracking-wide pl-3">Birthdays</p>
                    </router-link>
                    <p class="pt-12 uppercase font-bold text-gray-500 text-xs">Settings</p>
                    <router-link to="/logout" class="flex item-center py-2 hover:text-blue-600 text-sm">
                        <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
                            <path
                        ...
                        <p class="tracking-wide pl-3">Logout</p>
                    </router-link>
                </nav>
            </div>
